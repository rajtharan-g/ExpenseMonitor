...
class TransactionTableViewController: UITableViewController {
    ...
    @IBOutlet var transTableView: TableView!
    var user:String!
    var uid:String!
    ...
    override func viewDidLoad() {
        ...
        transTableView.placeholderDelegate = self
    }
    ...
    func getData(){
        ...
        self.transTableView.showLoadingPlaceholder()
        userRoot.observe(.value, with: { (snapshot) in
            ...
            if self.transactionsIncomeExpense.count == 0 {
                self.transTableView.showNoResultsPlaceholder()
            }
        })
    }
    }

extension TransactionTableViewController: PlaceholderDelegate {
